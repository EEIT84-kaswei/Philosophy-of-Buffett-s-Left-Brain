...
$(document).ready(function(){
	$("#table2 > tbody > tr > td:nth-child(6)").children().each(function(){
		$(this).click(function(){
...
<div style="width:1000px;height:600px">
  ...
  <table id="table2">
      <thead>
      			...
      			<tr><td><input type="text" size="12" name="deleteMsg"></td> 
                    <td><input type="submit" value="Delete" name="stockManage"></td></tr>
                    </form>
          <tr>
      ...
      <tbody>
      <tr>
              <td><input type="text" size="12" name="stock_Code" placeholder="股票編號"></td>
              <td><input type="text" size="12" name="stock_Name" placeholder="股票名稱"></td>
              <td><input type="text" size="12" name="stock_TypeCode" placeholder="股票分類"></td>
              <td><input type="text" size="12" name="cs_Code" placeholder="概念股分類"></td>
              <td><input type="text" size="12" name="commend" placeholder="風險等級"></td> 
          ...
          <tr>          	  
              ...
              <td><input type="text" name="stock_TypeCode" size="12" value="${row.stock_TypeCode}"></td>
              <td><input type="text" name="cs_Code" size="12" value="${row.cs_Code}"></td>
              <td><input type="text" name="commend" size="12" value="${row.commend}"></td> 
