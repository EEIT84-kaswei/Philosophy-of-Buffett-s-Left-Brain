				...
				<form>
					<c:if test="${not empty select}">
						<table class="table table-hover table-bordered"
							...
							<thead>
								<tr>
									<th style="text-align: center; background-color: #808080"><font
										style="color: #fff;font-size:120%">新聞標題</font></th>
									<th style="text-align: center; background-color: #808080"><font
										style="color: #fff;font-size:120%">發佈日期</font></th>
								</tr>
							</thead>
							<tbody>
								<c:forEach var="row" items="${select}">
									...
									<tr style="height: 100%">
										...
										<td style="text-align: center;width:20%"><fmt:formatDate
