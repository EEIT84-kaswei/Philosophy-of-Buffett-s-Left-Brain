...
//		dao.setSessionFactory(HibernateUtil.getSessionFactory());
		...
		// try {
		// dao.getSession().beginTransaction();
		// CustFavoriteBean selectByIdAndStock = service.selectByIdAndStock(1,
		// 4108);
		// dao.getSession().getTransaction().commit();
		...
		// 測試指標3
		// Integer [] top_B_s_sheets =
		// {5985,5640,3528,2486,1507,1351,1067,838,794,526,332,219,167,105,77};
		// Integer [] low_B_s_sheets =
		// {-2842,-2774,-2229,-2198,-2027,-790,-657,-495,-349,-318,-263,-262,-228,-193,-172};
		// int trade_Volume = 42324;
		// boolean test3 = false;
		// test3 = service.Stock_index3(top_B_s_sheets, low_B_s_sheets,
		// trade_Volume);
		...
		// Integer stock_Code = 2330;
		// boolean test4 = false;
		// test4 = service.Stock_index4(ldate1, FC_Trade_Count1, ldate2,
		// FC_Trade_Count2, ldate3, FC_Trade_Count3, stock_Code);
		...
		// Integer stock_Code = 2330;
		// boolean test5 = false;
		// test5 = service.Stock_index5(ldate1, IT_Trade_Count1, ldate2,
		// IT_Trade_Count2, ldate3, IT_Trade_Count3, stock_Code);
	...
	public boolean delete(String account, Integer stock_Code) {
		...
		if (account != null && stock_Code != null) {
			result = custFavoriteDAO.delete(account, stock_Code);
		}
		return result;
	}
