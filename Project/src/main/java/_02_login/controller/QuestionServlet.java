...
//		}
		...
		try {
			...
			service.insert(bean);
	//		request.setAttribute("AnswerBean", bean);           /secure/_01_register/questionnaire/types.jsp
			RequestDispatcher rd = request.getRequestDispatcher("/secure/_01_register/questionnaire/types.jsp");
			rd.forward(request, response);
//			if(Risk_Tolerance == 1){
